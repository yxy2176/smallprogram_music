...
__DEFINE__(1735350063179, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1735350063180,"./event-store":1735350063181}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1735350063180, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1735350063181, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1735350063180,"./utils":1735350063182}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1735350063182, function(require, module, exports) {
...
return __REQUIRE__(1735350063179);
})()
